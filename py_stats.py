...
if __name__ == "__main__":
	...
	#set up logging
	logging.basicConfig(filename="errorjournal.log",format='%(asctime)s %(message)s',level=logging.WARNING)
	...
	try:
		...
		logging.warning("Program was killed by user")	
		exit(0)
	except net_notif_except as n:
		logging.error(str(n))	
		exit(10)
	except store_results_except as s:
		logging.critical(str(n))
		exit(11)
	except speed_avg_except as a:
		logging.critical(str(a))
		exit(12)
	except get_stats_except as g:
		logging.critical(str(g))
		exit(13)
	except SystemExit as ex:
		logging.critical("Error: Unexpected runtime error")
